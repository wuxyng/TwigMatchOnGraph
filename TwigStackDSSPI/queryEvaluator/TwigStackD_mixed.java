...
public class TwigStackD_mixed {
	...
	public TwigStackD_mixed(TreeQuery query, ArrayList<ArrayList<Node>> invLsts, SSPIndex SSPI, Digraph G) {
	...
	public QueryEvalStat run() {
		...
		System.out.println("Time on TwigStackD_SSPI_mixed:" + matm + "sec.");
		tt.Start();
