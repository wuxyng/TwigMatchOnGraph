 ...
 */
public class TwigStackD_mixed_ag {
	...
	public TwigStackD_mixed_ag(TreeQuery query, ArrayList<ArrayList<Node>> invLsts, SSPIndex SSPI, Digraph G) {
	...
	public QueryEvalStat run() {
		...
		System.out.println("Time on TwigStackD_SSPI_MIXED_AG:" + matm + "sec.");
		tt.Start();
		calTotSolns();
