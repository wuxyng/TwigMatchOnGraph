 ...
 */
public class TwigStackD_mixed_ag_flt {
	...
	public TwigStackD_mixed_ag_flt(TreeQuery query, ArrayList<ArrayList<Node>> invLsts, SSPIndex SSPI, Digraph G) {
	...
	public QueryEvalStat run(double flttm) {
		...
		System.out.println("Time on TwigStackD_SSPI_MIXED_AG_flt:" + matm + "sec.");
		tt.Start();
		calTotSolns();
