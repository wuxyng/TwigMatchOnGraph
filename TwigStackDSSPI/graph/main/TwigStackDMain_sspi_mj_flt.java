 ...
 *
 */
public class TwigStackDMain_sspi_mj_flt {
	...
	public TwigStackDMain_sspi_mj_flt(String dataFN, String queryFN) {
	...
	private void evaluate() {
		for (int i = 0; i < Flags.REPEATS; i++) {
			for (int Q = 0; Q < queries_tree.size(); Q++) {
				...
				TwigStackD_mj_flt tsd = new TwigStackD_mj_flt(query_tree, invLsts_reduced, SSPI);
	...
	public static void main(String[] args) {
		...
		TwigStackDMain_sspi_mj_flt psMain = new TwigStackDMain_sspi_mj_flt(dataFileN, queryFileN);
		psMain.run();
	}
