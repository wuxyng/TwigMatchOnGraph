...
import queryEvaluator.TwigStackD_mixed_ag;
 ...
 *
 */
public class TwigStackDMain_sspi_mixed_ag {
	...
	public TwigStackDMain_sspi_mixed_ag(String dataFN, String queryFN) {

		queryFileN = Consts.INDIR + queryFN;
		dataFileN = Consts.INDIR + dataFN;
		stats = new QueryEvalStats(dataFileN, queryFileN, "TwigStackD-SSPI-MIXED-AG");
	}
	...
	private void evaluate() {
		for (int i = 0; i < Flags.REPEATS; i++) {
			for (int Q = 0; Q < queries.size(); Q++) {
				...
				System.out.println("\nEvaluating query " + Q + " ...");
				TwigStackD_mixed_ag tsd = new TwigStackD_mixed_ag(query, invLsts, SSPI, G);
	...
	public static void main(String[] args) {
		...
		TwigStackDMain_sspi_mixed_ag psMain = new TwigStackDMain_sspi_mixed_ag(dataFileN, queryFileN);
		psMain.run();
	}
