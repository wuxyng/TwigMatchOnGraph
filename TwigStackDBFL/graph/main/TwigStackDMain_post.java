 ...
 *
 */
public class TwigStackDMain_post {
	...
	public TwigStackDMain_post(String dataFN, String queryFN) {

		queryFileN = Consts.INDIR + queryFN;
		dataFileN = Consts.INDIR + dataFN;
		String suffix = ".csv";
		String fn = queryFN.substring(0, queryFN.lastIndexOf('.'));
		outFileN = Consts.OUTDIR + "sum_"+ fn+"_bflpost"+suffix;
		stats = new QueryEvalStats(dataFileN, queryFileN, "TwigStackD-bfl-post");
	}
	...
	public static void main(String[] args) {
		...
		TwigStackDMain_post psMain = new TwigStackDMain_post(dataFileN, queryFileN);
		psMain.run();
	}
