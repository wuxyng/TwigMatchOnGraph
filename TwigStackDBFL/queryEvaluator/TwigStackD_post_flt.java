 ...
 *
 */
public class TwigStackD_post_flt {
	...
	public TwigStackD_post_flt(TreeQuery query, ArrayList<ArrayList<GraphNode>> invLsts, BFLIndex bfl) {
	...
	public QueryEvalStat run(double flttm) {
		...
		if (success) {
			...
			twigStackD();
			matm = tt.Stop() / 1000;
			System.out.println("Time on TwigStackD_BFL_post_flt:" + matm + "sec.");
			tt.Start();
			// showSolutions();
