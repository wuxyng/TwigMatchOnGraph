...
public class CombinationIterator {
	...
	public static void main(String[] args) {
		...
		CombinationIterator combGen = new CombinationIterator(5, 3);
		...
		/*
		 * for(int i=0; i<10; i++){ int[] comb = combGen.getACombination();
		 * System.out.print( combGen._currentIndex + " == "); for(int c:comb){
		 * System.out.print( c+" "); }
		 * 
		 * System.out.println(); }
		 */
