...
public class BJFltMain {
	...
	public BJFltMain(String dataFN, String queryFN) {
	...
	private void evaluate() {
		...
		for (int i = 0; i < Flags.REPEATS; i++) {
			for (int Q = 0; Q < queries.size(); Q++) {
				...
				BJFlt eva = new BJFlt(query, fb, bfl, invLstsByID,bitsByIDArr);
	...
	public static void main(String[] args) {
		...
		BJFltMain demain = new BJFltMain(dataFileN, queryFileN);
