...
public class SimFltMain {
	...
	public SimFltMain(String dataFN, String queryFN) {
	...
	private void evaluate() {
		...
		for (int i = 0; i < Flags.REPEATS; i++) {
			for (int Q = 0; Q < queries.size(); Q++) {
				...
				SimFlt eva = new SimFlt(query, fb, bfl);
	...
	public static void main(String[] args) {
		...
		SimFltMain demain = new SimFltMain(dataFileN, queryFileN);
