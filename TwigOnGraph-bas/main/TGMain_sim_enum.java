...
import queryEvaluator.TG_sim_enum;



public class TGMain_sim_enum {
	...
	public TGMain_sim_enum(String dataFN, String queryFN) {
		...
		stats = new QueryEvalStats(dataFileN, queryFileN, "TwigListDPro_sim_enumSolns");
	}
	...
	private void evaluate() {
		for (int i = 0; i < Flags.REPEATS; i++) {
			for (int Q = 0; Q < queries.size(); Q++) {
				...
				System.out.println("\nEvaluating query " + Q + " ...");
				TG_sim_enum tld = new TG_sim_enum(query, invLsts, invLstsByID, bfl);
	...
	public static void main(String[] args) {
		...
		TGMain_sim_enum psMain = new TGMain_sim_enum(dataFileN, queryFileN);
		psMain.run();
