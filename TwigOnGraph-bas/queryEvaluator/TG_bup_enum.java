...
public class TG_bup_enum {
	...
	public TG_bup_enum(TreeQuery query, ArrayList<ArrayList<GraphNode>> invLsts, BFLIndex bfl) {
	...
	public TG_bup_enum(TreeQuery query, ArrayList<ArrayList<GraphNode>> invLsts,
	...
	public QueryEvalStat run() {
		...
		System.out.println("Time on TwigListD_bup_pro_enum:" + matm + "sec.");
		tt.Start();
		enumTuples();
		// printSolutions();
		//calTotSolns();
